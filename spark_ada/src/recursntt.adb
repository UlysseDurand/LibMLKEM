    ...
    begin
        if E'Length = 1 then
            ...
            begin
                ...
                pragma Assert (E'Length > 1);
                pragma Assert (E'Last > E'First);
                ...
                for J in 0 .. (E'Length / 2 - 1) loop
                    ...
                    pragma Loop_Invariant (for all K in 0 .. J => Res (Index_Ref (K))'Initialized);
                    pragma Loop_Invariant (for all K in E'Length / 2 .. E'Length / 2 + J => Res (Index_Ref (K))'Initialized);
                end loop;
